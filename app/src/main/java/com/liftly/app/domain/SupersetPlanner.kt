...
/** Dois exercícios consecutivos marcados como Bi-set/Supersérie formam um único grupo. */
object SupersetPlanner {
    ...
    /** null significa continuar imediatamente para o parceiro; caso contrário inicia descanso. */
